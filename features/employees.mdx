...
description: "The Employees module registers staff in Corpointa. Each employee belongs to a destination and can be assigned as the recipient of a material dispatch."
---
