...
description: "The Corpointa Dashboard shows live KPI cards for materials, stock, movements, and low-stock alerts, plus monthly entry/exit charts and recent dispatch history."
---
...
interface DashboardStats {
  ...
  /** Monthly breakdown for the bar/pie charts */
