...
description: "Units of measure set the counting standard for each material in Corpointa — Unidad, Kg, Litro, Metro, and more. Every material must have a unit assigned."
---
