---
title: "Deploy Corpointa to Netlify"
sidebarTitle: "Netlify"
description: "Deploy the Corpointa frontend to Netlify with SPA redirect support. Set your VITE_API_URL environment variable and configure the build command to publish the dist/ folder."
---
...
<Steps>
  ...
  <Step title="Add environment variables">
    Go to **Site configuration → Environment variables** and add at minimum:

    ```bash
    VITE_API_URL=https://api.corpointa.example.com
    ```

    If you are using Clerk authentication, also add:
