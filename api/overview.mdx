...
description: "Corpointa communicates with a REST API backend over HTTP. Learn how the Axios client is configured, what the base URL default is, and how authentication tokens are attached."
---
...
```bash
# .env.example
VITE_API_URL=   # defaults to http://localhost:4000 when unset
```
