...
description: "Corpointa is a React 19 inventory management frontend that connects to a REST API backend, providing full CRUD for materials, stock, movements, and warehouse contacts."
---
